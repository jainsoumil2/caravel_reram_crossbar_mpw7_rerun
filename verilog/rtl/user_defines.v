...
`define USER_CONFIG_GPIO_25_INIT `GPIO_MODE_USER_STD_ANALOG 			// 14
`define USER_CONFIG_GPIO_26_INIT `GPIO_MODE_USER_STD_ANALOG 			// 15
`define USER_CONFIG_GPIO_27_INIT `GPIO_MODE_USER_STD_ANALOG 			// 16
`define USER_CONFIG_GPIO_28_INIT `GPIO_MODE_USER_STD_ANALOG 			// 17
`define USER_CONFIG_GPIO_29_INIT `GPIO_MODE_USER_STD_INPUT_PULLDOWN 		// 18	
`define USER_CONFIG_GPIO_30_INIT `GPIO_MODE_USER_STD_INPUT_PULLDOWN 		// 19
`define USER_CONFIG_GPIO_31_INIT `GPIO_MODE_USER_STD_INPUT_PULLDOWN 		// 20
`define USER_CONFIG_GPIO_32_INIT `GPIO_MODE_USER_STD_ANALOG 			// 21
`define USER_CONFIG_GPIO_33_INIT `GPIO_MODE_USER_STD_INPUT_PULLDOWN 		// 22
`define USER_CONFIG_GPIO_34_INIT `GPIO_MODE_USER_STD_ANALOG 			// 23
`define USER_CONFIG_GPIO_35_INIT `GPIO_MODE_USER_STD_ANALOG 			// 24
`define USER_CONFIG_GPIO_36_INIT `GPIO_MODE_USER_STD_INPUT_PULLDOWN 		// 25
`define USER_CONFIG_GPIO_37_INIT `GPIO_MODE_USER_STD_INPUT_PULLDOWN 		// 26
